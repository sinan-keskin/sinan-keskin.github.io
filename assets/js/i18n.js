...
(function() {
  ...
  const translations = {
    en: {
      ...
      'form-legal-notice': 'By transmitting, you agree to the',
      'form-legal-and': 'and',
      'form-legal-suffix': '.',
    ...
    tr: {
      ...
      'footer-terms': 'KULLANICI SÖZLEŞMESİ',
      'form-legal-notice': 'Mesaj ileterek',
      'form-legal-and': 've',
      'form-legal-suffix': '\'ni kabul etmiş olursunuz.',
